...
class Inject extends Agent
{
    ...
    public function init()
    {
        ...
        $this->node_list = array("inject"=>array("inject"));
    ...
    function set($requested_state = null)
    {
        ...
        $this->thing->log($this->agent_prefix . 'set Inject to ' . $this->state, "INFORMATION");
    }
    ...
    function get()
    {
        ...
        if (!$this->isInject($this->previous_state)) {
    ...
    {
       $this->thing->choice->Create($this->agent_name, $this->node_list, "inject");
       $this->choices = $this->thing->choice->makeLinks('inject');
    ...
    function makeMessage()
    {
        ...
        $uuid = $this->uuid;
        $message .= "<p>" . $this->web_prefix . "thing/$uuid/inject\n \n\n<br> ";
    ...
    function makeWeb()
    {
        $link = $this->web_prefix . 'thing/' . $this->uuid . '/inject';

        $this->node_list = array("inject"=>array("inject", "rocky", "bullwinkle","charley"));
        // Make buttons
...
//        $web .= nl2br($this->short_message) . "<br>";
        ...
        $link = $this->web_prefix . 'thing/' . $this->uuid . '/inject.pdf';
    ...
    public function makePDF()
    {
        ...
        $pdf->Write(0, $text);
            ...
            $this->getQuickresponse($this->web_prefix . 'thing\\' . $this->uuid . '\\inject');
	...
	public function readSubject()
    {
        ...
        $keywords = array("inject", "hard", "16ln", "easy","hey", "rocky","charley","bullwinkle","natasha","boris");
