...
class Librex extends Word
{
    ...
    function init()
    {
        ...
        $this->librex_variables = new Variables(
            $this->thing,
            "variables librex " . $this->from
        );
    }
    ...
    function get()
    {
        $this->previous_librex_name = $this->librex_variables->getVariable(
            "librex_name"
        );
    ...
    function set()
    {
        ...
        $this->thing_report["help"] =
            "Reads the short message for a librex reference.";
    }
...
*/
    ...
    {
        if (!isset($this->librex)) {
            $this->getLibrex($this->librex_name);
        }
    ...
    function getHits($searchfor = null)
    {
        ...
        while ($line !== false) {
            if (
                stripos($line, $searchfor) !== false or
                stripos($searchfor, $line) !== false
            ) {
                $this->hits[] = $line;
            }
...
*/
    ...
    public function respondResponse()
    {
        ...
        $this->thing_report["help"] =
            "Reads the short message for matches against a librex.";
    ...
    public function readSubject()
    {
        ...
        if (
            ...
            strtolower($this->agent_input) == "librex"
        ) {
