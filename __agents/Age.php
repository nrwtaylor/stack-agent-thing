...
class Age extends Chart
{
    ...
    function drawGraph() {
        ...
        foreach ($this->tubs as $index=>$tub_quantity) {
            ...
            $h_offset = $y - $y_origin;
            //echo ($this->height - $y_origin - $y) ." " .($this->height - $y_origin) ." " . $y . " " . $y_origin ." " ."<br>";
            $h_offset = ($this->height - $y_origin - $y) / 2;
            imagefilledrectangle($this->image,
                $x - $width / 2 - $offset , $this->height - $y_origin + $h_offset - $this->height/2,
                $x + $width / 2 + $offset, $y + $h_offset-$this->height/2,
                $this->red);
        ...
        $allowed_steps = array(1, 2, 5, 10, 20, 25, 50, 100, 200, 250, 500, 1000, 2000, 2500, 10000, 20000, 25000, 100000, 200000, 250000);
        $inc = ($y_max - $y_min)/ 5;
        ...
        //        $this->drawGrid(-$this->y_max, $this->y_max, $preferred_step);
    }
