...
//        $this->app_token = $this->thing->container['api']['microsoft']['app token'];
        $this->client_id = $this->thing->container['api']['discord']['edna']['client_id'];
        //$this->app_secret = $this->thing->container['api']['discord']['edna']['client_secret'];
        $this->token = $this->thing->container['api']['discord']['edna']['token'];

//        $this->permissions_integer = 536874048;
        $this->permissions_integer = 3072;
...
/*
        curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json',
                ...
                'User-Agent: Edna (https://stackr.ca, v0.0.1)'
        ));
*/
