...
class Nonsense
{
    ...
    function __construct(Thing $thing, $agent_input = null)
    {
        ...
        $time_string = $this->thing->json->readVariable( array("nonsense", "refreshed_at") );

        if ($time_string == false) {
            $this->thing->json->setField("variables");
            $time_string = $this->thing->json->time();
            $this->thing->json->writeVariable( array("nonsense", "refreshed_at"), $time_string );
        }
        ...
        $this->thing->log( $this->agent_prefix .'completed setNonsense. Timestamp = ' . number_format($this->thing->elapsed_runtime()) .  'ms.', "OPTIMIZE" );
...
//        $this->makePNG();
    ...
    function makeChoices ()
    {
       ...
       $this->thing->choice->Create($this->agent_name, $this->node_list, "nonsense");
    ...
    function makeMessage()
    {
        ...
        $message .= "<p>" . $this->web_prefix . "thing/$uuid/nonsense\n \n\n<br> ";
...
//        }
        ...
        $this->thing->log($this->agent_prefix . ' loaded nonsense index ' . $this->index . '.', "INFORMATION") ;
        return;
    }
