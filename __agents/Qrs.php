...
class Qrs
{
    ...
    function __construct(Thing $thing, $agent_input = null)
    {
        ...
        $this->node_list = array("qrs"=>array("index", "uuid"));
...
*/
    ...
    function init()
    {
        ...
        if (!isset($this->max)) {$this->max = 221;}
...
//        $this->makePNG();
    ...
    function makeMessage()
    {
        ...
        $message .= "Keep on stacking.\n\n<p>" . $this->web_prefix . "thing/$uuid/qrs\n \n\n<br> ";
    ...
    {
        $this->thing->json->setField("variables");
        $this->thing->json->writeVariable( array("qrs", "index"), $this->index );
    ...
    function getNuuids()
    {
        ...
        $this->thing->json->setField("variables");
        $this->index = $this->thing->json->readVariable( array("qrs", "index") );
        ...
        $this->thing->log($this->agent_prefix . ' loaded qrs index ' . $this->index . '.', "INFORMATION") ;
        return;
    }
