...
class Impressum extends Agent
{
    ...
    public function pdfImpressum($pdf = null)
    {
        try {
            ...
            // prod March 16 2022
            // use older pattern
            $qr_handler = new Qr($this->thing, $link);
            $quick_response_png = $qr_handler->PNG_embed;
            $pdf->Image($quick_response_png, 175, 5, 30, 30, "PNG");
            ...
            $pdf->SetXY(15, $y);
            $text =
                "Printed text and graphics (c) 2020-2022 " . $this->entity_name;
