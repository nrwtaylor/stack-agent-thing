...
class Enddate extends Agent
{
    ...
    function get($end_at = null)
    {
        ...
        $this->enddate = new Variables(
            $this->thing,
            "variables enddate" . $flag_variable_name . " " . $this->from
        );
    ...
    /**
     * Ensure consistency between Enddate and Endat for day.
     */
    function setEndat()
    {
        ...
        $endat = new Endat($this->thing, "endat");

        if (strtoupper($endat->day) != strtoupper($day)) {
            $command = "endat " . $day;
            $this->response .= "Changed endat day to " . $day . ". ";
            $endat = new Endat($this->thing, $command);
        }
    }
    ...
    public function respondResponse()
    {
        if ($this->response == null) {
            $this->response .= "Retrieved end at day.";
        }
    ...
    public function readSubject()
    {
        ...
        $this->extractEnddate($filtered_input);
