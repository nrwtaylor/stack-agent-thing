...
class Wanderingearth extends Agent {
    ...
    public function respond() {
        ...
        $this->thing_report["info"] = "This is a cat keeping an eye on how late this Thing is.";
        $this->thing_report["help"] = "This is a quote from a movie.";
    ...
    function doCat($text = null) {
        ...
        if ($this->agent_input == null) {
            $array = array('Beijing No.3 transportation division reminds you that routes are countless but safety is foremost. Unregulated driving will cause loved ones to end up in tears.');
            $k = array_rand($array);
            $v = $array[$k];
