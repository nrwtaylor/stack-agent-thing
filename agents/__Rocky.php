...
return;
    ...
    function getBank()
    {
        if (!isset($this->bank)) {$this->bank = "easy-a02";}
        return $this->bank;
    }
...
//                $max_line_length = 0;
                ...
                if ($bank_info == null) {
                    ...
                    $bank_info = array("title"=>$title, "author"=>$author, "date"=>$date, "version"=>$version);
                    continue;
                }
...
//            $this->inject = $this->bank ."-". $this->num;
    ...
    function getMessage()
    {
        ...
        $this->number_to = $this->message['number_to'];
