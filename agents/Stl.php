...
// Feel free to use the attached PHP file for your own purposes, but I’d appreciate you leaving my developer info in the file, and an email/comment letting me know that you found it helpful.
// Courtesy Michael D. Schmidt
// http://schmidtcds.com/files/stlvolume.txt

$filepath = $this->resource_path . 'stl/d20.STL';
//$filepath = $this->resource_path . 'stl/d20-whole-nums.stl';
...
$normal_vector = array($normalVectorsX[$i],$normalVectorsY[$i],$normalVectorsZ[$i]);

$triangle = array("normal"=>$normal_vector,"vertices"=>array($point[0],$point[1],$point[2]));
