...
//        $this->page_access_token = $this->thing->container['api']['facebook']['page_access_token'];
		...
		$this->thing->log( 'Agent "Microsoft" running on Thing ' .  $this->thing->nuuid . '.' );
		$this->thing->log( 'Agent "Microsoft" received this Thing "' .  $this->subject . '".' );
		...
		if ( $this->readSubject() == true) {
			$this->thing_report = array('thing' => $this->thing->thing, 
		        ...
		        $this->thing->log( 'Agent "Microsoft" completed without sending a message.' );
			return;
		}
		$this->respond();
    ...
    function eventSet($input = null)
    {
        ...
        $this->thing->json->writeVariable( array("microsoft") , $input  );
...
//			$this->thing->log("FB message sent");
			...
			$this->thing_report['info'] = '<pre> Agent "Microsoft" sent a message to ' . $this->from . '.</pre>';
//
//		} else {
//
...
//$message_reply_id = $this->agent_input;
                    ...
                    $names = $this->thing->json->writeVariable( array("microsoft", "reply_id"), null );
...
//var_dump($result);
                    ...
                    $this->thing->json->setField("variables");
                    $names = $this->thing->json->writeVariable( array("microsoft", "result"), $result );
                        $time_string = $this->thing->json->time();
                        $this->thing->json->writeVariable( array("microsoft", "refreshed_at"), $time_string );
