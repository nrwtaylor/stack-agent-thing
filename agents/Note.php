...
//vhttps://www.reddit.com/r/oddlyterrifying/comments/4g0i0m/the_ibm_7094_the_first_computer_to_sing_singing/
...
//        $this->thing = $thing;
        ...
        $notes = array(array("bpm"=>120),
                ...
                array("bar 7"),
                array("note"=>"A","length"=>0.5),
                array("note"=>"F#_","length"=>1.5),
                array("note"=>"F#","length"=>2),
 ...
 array("bar 12"),
                ...
                array("note"=>"C","length"=>1),
                array("note"=>"A_","length"=>0.5),
                array("note"=>"B_","length"=>0.5),

                array("barline"),
                array("bar 18"),
                array("note"=>"C_","length"=>1),
                array("note"=>"F","length"=>1),
                array("note"=>"G_","length"=>0.5),
                array("note"=>"F_","length"=>0.5),
                array("note"=>"E_","length"=>0.5),
                array("note"=>"D_","length"=>0.5),

                array("barline"),
                array("note"=>"D_","length"=>0.5),
                array("note"=>"E_","length"=>0.5),
                array("note"=>"F_","length"=>1),
                array("note"=>"F","length"=>1),
                array("note"=>"G","length"=>0.5),
                array("note"=>"A5","length"=>0.5),

                array("barline"),
                array("note"=>"A5#","length"=>0.5),
                array("note"=>"A5#","length"=>0.5),
                array("note"=>"A5","length"=>1),
                array("note"=>"G","length"=>1),
                array("note"=>"F","length"=>0.5),
                array("note"=>"G","length"=>0.5),
        ...
        // https://commons.wikimedia.org/wiki/File:Daisy_Bell_(bicycle_built_for_two)_(NYPL_Hades-448698-1689570).jpg

        $notes = array(array("bpm"=>45),
                array("note"=>"C5","length"=>3),

                array("barline"),
                array("bar 2"),
                array("note"=>"A5", "length"=>3),

                array("barline"),
                array("note"=>"F","length"=>3),

                array("barline"),
                array("note"=>"C","length"=>3),
                ...
                array("barline"),
                array("note"=>"D","length"=>2),
                array("note"=>"F","length"=>1),

                array("barline"),
                array("note"=>"C_","length"=>3),

                array("barline"),
                array("note"=>"C","length"=>3),

          array("barline"),
                array("note"=>"D","length"=>3),

          array("barline"),
                array("note"=>"A#5","length"=>3),
          ...
          array("barline"),
                array("note"=>"G","length"=>2),
                array("note"=>"A5","length"=>1),

          array("barline"),
                array("note"=>"G_","length"=>3),
          ...
          array("barline"),
                array("note"=>"C5","length"=>2),
                array("note"=>"A5","length"=>1),

          array("barline"),
                array("note"=>"G","length"=>1),
                array("note"=>"F_","length"=>2),
          ...
          array("barline"),
                array("note"=>"D","length"=>1),
                array("note"=>"C_","length"=>2),

          array("barline"),
                array("note"=>"C","length"=>2),
                array("note"=>"C","length"=>1),
...
foreach ($notes as $temp=>$note) {
    ...
    switch (true) {
        ...
        case ((isset($note[0])) and (strpos($note[0], 'bar') !== false)):
            echo $note[0];
            break;

        case (isset($note["bpm"])):
            $this->bpm = (int) $note["bpm"];
            echo "bpm " . $this->bpm . "\n";
            break;
...
*/
    ...
    function sampleTone($frequency, $num_beats, $bpm = null, $tone_width = 0.2)
    {
        if ($bpm == null) {
            if (isset($this->bpm)) {
                $bpm = $this->bpm;
...
//exit();
    ...
    function frequencyTone($note, $octave = null)
    {
