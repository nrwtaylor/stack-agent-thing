...
class Unsubscribe {
	...
	function __construct(Thing $thing) {
		...
		$this->node_list = array("unsubscribe"=>array("opt-in", "start"));


        $this->thing->log( $this->agent_prefix . 'running on Thing '. $this->thing->nuuid . '.</pre>');


        $this->variables_agent = new Variables($this->thing, "variables unsubscribe " . $this->from);
...
//        $this->thing->choice->save('usermanager', $this->state);
    ...
    function get()
    {
        ...
        $this->thing->log( $this->agent_prefix .  'has been run ' . $this->counter . " times.", "DEBUG");
    ...
    private function makeSMS() {
        ...
        switch ($this->counter) {
            case 1:
                $sms = "UNSUBSCRIBE | This device has been unsubscribed from Stackr.  Read our Privacy Policy " . $this->web_prefix . "policy";
                break;
            case 2:
                $sms = "UNSUBSCRIBE | Unsubscribed. " . $this->web_prefix . "privacy";
                break;
    ...
    private function makeEmail() {
        ...
        switch ($this->counter) {
            case 1:
                ...
                $message = "You have been unsubscribed from Stackr.
                    <br>
                    Email start" . $this->mail_postfix . " to start again.
                    <br>
            ...
            default:
                $message = "Unsubscribe acknowledged.  " . $this->web_prefix . "privacy";
...
//    }
    ...
    {
        // Make buttons
        $this->thing->choice->Create($this->agent_name, $this->node_list, "unsubscribe");
	...
	public function respond() {
        ...
        $this->thing_report['help'] = $this->agent_prefix  .'responding to an instruction to unsubscribe.';
...
//		$this->thing->choice->Choose("new user");
	...
	function unsubscribe() {
        ...
        $this->thing->log( $this->agent_prefix .'called the Usermanager to update user state to unsubscribe.' );
