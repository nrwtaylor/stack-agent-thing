...
class SpaceWeather extends Agent
{
    ...
    function init()
    {
        ...
        //$this->link = "https://weather.gc.ca/rss/city/bc-74_e.xml";
        $this->link = "https://spaceweather.gc.ca/rss_feed/rss_feed_eng.xml";
