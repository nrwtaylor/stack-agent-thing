...
class Morse extends Agent
{
    ...
    function run()
    {
        if ($this->morse != false) {
            ...
            $this->thing->log(
                "completed with a reading of " . $this->morse . "."
            );
        } else {
    ...
    function getConcept($test)
    {
        ...
        $word = ["morse" => $morse, "english" => $english];
...
他的一个学生在师大工作。　他有汉语书，法语书和日语书。　他天天教留学生现代汉语。现在他有五个男学生，八个女学生。";
        ...
        $input =
            "This is a mix of morse .. - .... -.- characters and english words.";
    ...
    public function readSubject()
    {
        ...
        if (count($this->morse_words) > 0) {
            $has_morse_characters = true;
        } else {
            $has_morse_characters = false;
        }
                    ...
                    switch ($piece) {
                        case "morse":
                            ...
                            if ($arr == null) {
                                ...
                                $this->morse_words = $this->extractMorse(
                                    implode(" ", $arr)
                                );
                            }
                            return;
