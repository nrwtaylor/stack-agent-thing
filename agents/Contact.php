...
class Contact
{
    ...
    function __construct(Thing $thing, $agent_input = null)
    {
        ...
        $this->agent_prefix = 'Agent "Contact" ';
		...
		$this->node_list = array("contact"=>array("privacy", "weather"));
	...
	private function respond()
    {
		...
		$this->thing_report['help'] = 'Contact manager';
    ...
    private function makeSMS()
    {
        if (!isset($this->sms_message)) {
            $this->sms_message = "CONTACT | Message not understood.";
        }
    ...
    {
        $this->thing->choice->Create($this->agent_name, $this->node_list, "contact");
