...
class Splosh extends Agent
{
    ...
    // This will provide a splosh - imagine walking up a flowing river of mud.
    ...
    private function sploshEnergy($energy_text = null)
    {
        ...
        $this->distance_acceleration =
            ($this->acceleration * $tick_time * $tick_time) / 2;
        $this->distance_velocity = $this->velocity * $tick_time;

        $distance_energy =
            $this->distance_acceleration + $this->distance_velocity + $distance;
    ...
    private function getDistance()
    {
        ...
        if (!isset($this->distance) or $this->distance == false) {
            $this->distance = 0;
        }
    ...
    public function readSubject()
    {
        ...
        $this->message =
            "https://dictionary.cambridge.org/dictionary/english/splosh";
        $this->keyword = "splosh";
    ...
    public function makeWeb()
    {
        ...
        $html .=
            "<br>Distance just sploshed is " .
            $this->distance_travelled .
            $this->distance_unit_name;
        $html .=
            "<br>Total distance sploshed " .
            $this->distance .
            $this->distance_unit_name;
        $html .=
            "<br>Elapsed time between splash " .
