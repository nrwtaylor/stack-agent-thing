...
class Job extends Agent {
    ...
    function init() {
        ...
        $this->thing_report['help'] = "Creates a unique reference for a job. Try WEB.";
    ...
    function set() {
        ...
        $this->thing->json->writeVariable(array("job",
   ...
   public function makeImage()
    ...
    function makeTXT()
    {
        ...
        //if ($job_proof == null) {
            $job_proof = "I will need this <thing> from <you?> to prove it is done.";
        //}
        ...
        if ($this->verbosity >=1) {
            ...
            $this->txt_message .= "This template job is hosted by the " . ucwords($this->word) . " service.  Read the privacy policy at " . $this->web_prefix . "privacy";
...
switch ($this->index_type) {
    ...
    default:
        ...
        $pdf->Image($this->nuuid_png, 5, 18, 20, 20, 'PNG');
            ...
            $text = "Pre-printed text and graphics (c) 2018-2019 " . $this->entity_name;
    ...
    function makeSMS() {
        ...
        if ($this->verbosity >=1) {
            ...
            $this->sms_message .= " | " . $this->web_prefix . "thing/" . $this->uuid ."/job" . " | Made up a job at " . $this->thing->thing->created_at. ".";
