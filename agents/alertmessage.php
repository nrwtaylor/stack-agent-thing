...
//        if ($this->agent_input != null) {
            $this->sms_message = "" . $this->alert_message;
//        }
...
//        $this->sms_message .= " | " . number_format( $this->thing->elapsed_runtime() ) . "ms.";
		...
		$this->thing_report[ "choices" ] = $choices;
 		$this->thing_report["info"] = "This creates an alerttag message."; 
 		$this->thing_report["help"] = "This is about alert message injection.";
