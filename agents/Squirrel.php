...
class Squirrel extends Agent {
    ...
    public function makeWeb() {
        $file = $GLOBALS['stack_path'] . 'resources/squirrel/squirrel.html';
    ...
    public function makeSMS() {
        $sms = "SQUIRREL | " . $this->thing_report['sms'];
...
//        $this->makeChoices();
    ...
    public function readSubject() {
        ...
        $this->thing_report['request'] = "What is Squirrel?";
