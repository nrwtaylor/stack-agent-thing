...
class Dictionary 
{
    ...
    function __construct(Thing $thing, $agent_input = null)
    {
        ...
        $this->agent_prefix = 'Agent "Dictionary" ';

        //$this->node_list = array("off"=>array("on"=>array("off")));

        $this->keywords = array('meaning','definition','dictionary','dictionaries','english','spanish','german');
...
return;
    ...
    public function getDictionary()
    {
        ...
        $oxford_dictionaries = new Oxforddictionaries($this->thing, "oxforddictionaries " . $this->search_words);
...
//        $this->thingreportEventful();
    ...
    {
        if (!isset($this->definitions)) {$this->getDictionary();}
   ...
   //     //$this->thing->log("read subject nextblock");
    ...
    default:
        ...
        if (($pos = strpos(strtolower($input), "dictionary is")) !== FALSE) { 
            $whatIWant = substr(strtolower($input), $pos+strlen("dictionary is")); 
        } elseif (($pos = strpos(strtolower($input), "dictionary")) !== FALSE) { 
            $whatIWant = substr(strtolower($input), $pos+strlen("dictionary")); 
        }
    ...
    if ($filtered_input != "") {
        ...
        $this->response = "Asked Dictionary about the word " . $this->search_words . ".";
        return false;
    }
