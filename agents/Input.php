...
//var_dump($last_thing->variables);
                //                $this->putinBasket($uuid);

//$this->getPrior();
//$thing = $this->prior_thing['thing'];
//$t = new Thing($thing->uuid);
//var_dump($t);
//$input_agent = $t->json->readVariable(array("input","agent"));

//if ($input_agent != false) {
//    $this->input_agent = $input_agent;
//}
//var_dump($t->json->readVariable(array("wumpus")));
//var_dump($t->json->readVariable(array("place")));
