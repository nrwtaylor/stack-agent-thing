...
//}
    ...
    function updateCell($q,$r,$s)
    {
        ...
        echo "( " . $q . ", ".  $r . ", " . $s . ") ";
        echo " | " . $states[0] . ' ' . $states[1] .' ' . $states[2] .' ' .$states[3] . $states[4] .' ' .$states[5];

        echo " | " . $n . " " . $p_melt . " " . $p_freeze;
        echo "<br>";
...
//        $this->lattice[0][0][0] = $value; 
       ...
       // $s_array= array(-2,-1,0,1,2);
        ...
        //$q_array= array(0,1,2,3,4,5);
       //$r_array= array(0,-1,-2,-3,-4,-5);
       // $s_array= array(0,1,2,3,4,5);

        $point_list = array(array(0,0,0),
                            array(1,-1,0),
                            array(2,-2,0),
                            array(3,-3,0),
                            array(2,-1,1),
...
//echo "<br>";
                 //   $this->updateCell($q,$r,$s);
                    ...
                    $color = $this->black;
                    if ($cell['state'] == 'on') {$color = $this->grey;}
...
//                    $angle = $i/5 * 3.14159;
                  ...
                  //$this->drawHexagon(-1*$s,$q,$r,$center_x,$center_y,$angle,$size,$this->green);
