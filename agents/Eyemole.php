...
class Eyemole {
	...
	function __construct(Thing $thing, $agent_input = null)
    {
        ...
        $this->agent_prefix = 'Agent "Eyemole" ';

        $this->thing_report['thing'] = $thing;

	    $this->uuid = $thing->uuid;

        $this->resource_path = $GLOBALS['stack_path'] . 'resources/eyemole/';
        ...
        $time_string = $this->thing->json->readVariable( array("eyemole", "refreshed_at") );

        if ($time_string == false) {
            //$this->thing->json->setField("variables");
            $time_string = $this->thing->json->time();
            $this->thing->json->writeVariable( array("eyemole", "refreshed_at"), $time_string );
        }

        // If it has already been processed ...
        $this->reading = $this->thing->json->readVariable( array("eyemole", "reading") );
    ...
    function getEyemole()
    {
        ...
        $file = $this->resource_path . 'eyemole.txt';
