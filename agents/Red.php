...
//                                'negative_time'=>'yes'),
        ...
        $this->thing->log('<pre> Agent "Red" running on Thing '. $this->thing->nuuid . '.</pre>');
        $this->thing->log('<pre> Agent "Red" received this Thing "'.  $this->subject . '".</pre>');
