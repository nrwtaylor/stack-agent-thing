   ...
   function __construct(Thing $thing, $agent_input = null)
    {
        ...
        $this->node_list = array("picanic"=>array());
...
*/
        ...
        $this->thing->json->setField("variables");
        $time_string = $this->thing->json->readVariable( array("picanic", "refreshed_at") );

        if ($time_string == false) {
            $this->thing->json->setField("variables");
            $time_string = $this->thing->json->time();
            $this->thing->json->writeVariable( array("picanic", "refreshed_at"), $time_string );
        }
        ...
        $this->thing->json->setField("variables");
        $this->nom = strtolower($this->thing->json->readVariable( array("picanic", "nom") ));
        $this->number = $this->thing->json->readVariable( array("picanic", "number") );
        $this->suit = $this->thing->json->readVariable( array("picanic", "suit") );
        ...
        if ( ($this->nom == false) or ($this->number == false) or ($this->suit == false) ) {
            ...
            $this->thing->json->writeVariable( array("picanic", "nom"), $this->nom );
            $this->thing->json->writeVariable( array("picanic", "number"), $this->number );
            $this->thing->json->writeVariable( array("picanic", "suit"), $this->suit );
...
//        $this->getResponse($this->nom, $this->suit);
    ...
    {
       $this->thing->choice->Create($this->agent_name, $this->node_list, "picanic");
    ...
    function getCast()
    {
        ...
        $file = $this->resource_path .'/whereisyogi/yogi.txt';
    ...
    function getName($role = null)
    {
        ...
        if ($role == "X") {$this->picanic = "Where is Yogi"; return;}

        $this->picanic = array_rand(array("picnic", "picanick", "picanic", "piknick"));
...
//        $this->response = "to: " . $this->fictional_to . ", " . $this->role_to . " from: " . $this->fictional_from . ", " . $this->role_from . " / " . $this->text . " / " . $this->number . " " . $this->unit . ".";
        $this->response = "TO " . $this->fictional_to .
            ...
            $this->fictional_from . ", " . $this->role_from . "\n" .
             "You now have " . strtolower($this->text) . "\n". $this->nom . " " . $this->unit;
// . $this->number . " " . $this->unit . ".";
    ...
    function makeMessage()
    {
        ...
        $message .= "<p>" . $this->web_prefix . "thing/$uuid/picanic\n \n\n<br> ";
