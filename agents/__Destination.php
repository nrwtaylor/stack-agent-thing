...
//$this->route = new Route($this->thing,"route");
//var_dump($this->route->route);
...
//var_dump($this->context->context);
//var_dump($this->context->context_id);

$this->context->context = "transit";

switch ($this->context->context) {
    case "group":
        $this->assertDestination($input);
        $this->destination_name = $this->destination_input;

        $this->destination_name = "richmond guide house";
        $this->route_list_text = $this->destination_name;
        break;
