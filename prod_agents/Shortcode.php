...
//    $newValue = $array[0] . " - " . $array[1] . " - " . $array[2] . " - " . $array[3];
            ...
            $newValue = "X";
            if (isset($this->{strtolower($match)})) { $newValue = $this->{strtolower($match)}; }
            if (!isset($this->{strtolower($match)})) { 
                if (isset($this->thing->container['stack'][$match])) { $newValue = $this->thing->container['stack'][$match];}
            }
